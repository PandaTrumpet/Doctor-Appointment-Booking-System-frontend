...
const MyProfile = () => {
  ...
  const updateUserProfileData = async () => {
    try {
      ...
      formData.append("gender", JSON.stringify(userData.gender));
      formData.append("dob", JSON.stringify(userData.dob));
    ...
    userData && (
      <section className="max-w-lg flex flex-col gap-2 text-sm">
        {isEdit ? (
          ...
          <img src={userData.image} alt="User foto" className="w-36 rounded" />
        )}
